...
ASGNI4
line 21
;21:		} else if (Q_stricmp(txt, "final") == 0) {
ADDRGP4 $77
JUMPV
LABELV $76
ADDRLP4 0
...
NEI4 $79
line 22
;22:			level = UI_GetNumSPTiers() * ARENAS_PER_TIER;
ADDRLP4 40
...
LABELV $74
line 25
;25:	trap_Cvar_SetValue("ui_spSelection", level);
ADDRGP4 $82
ARGP4
ADDRLP4 4
INDIRI4
...
line 27
;26:
;27:	map = Info_ValueForKey(arenaInfo, "map");
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 $83
...
ASGNP4
line 28
;28:	trap_Cmd_ExecuteText(EXEC_APPEND, va("spmap %s\n", map));
ADDRGP4 $84
ARGP4
ADDRLP4 8
INDIRP4
