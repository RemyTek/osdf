...
void CG_UpdateCvars(void) {
	...
	// if model changed
	if (forceModelModificationCount != cg_forceModel.modificationCount || enemyModelModificationCount != cg_enemyModel.modificationCount ||
	    enemyColorsModificationCount != cg_enemyColors.modificationCount || teamModelModificationCount != cg_teamModel.modificationCount ||
	    teamColorsModificationCount != cg_teamColors.modificationCount) {
