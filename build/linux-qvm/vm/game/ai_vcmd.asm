...
;42:	char* cmd;
;43:	void (*func)(bot_state_t* bs, int client, int mode);
;44:} voiceCommand_t;
;45:#endif
;46:
;47:/*
...
ASGNF4
line 130
;129:		// set the time to send a message to the team mates
;130:		bs->teammessage_time = FloatTime() + 2 * random();
ADDRLP4 0
ADDRGP4 rand
CALLI4
ASGNI4
...
ASGNF4
line 132
;131:		// set the ltg type
;132:		bs->ltgtype = LTG_ATTACKENEMYBASE;
ADDRFP4 0
INDIRP4
CNSTI4 6600
ADDP4
...
ASGNI4
line 134
;133:		// set the team goal time
;134:		bs->teamgoal_time   = FloatTime() + TEAM_ATTACKENEMYBASE_TIME;
ADDRFP4 0
INDIRP4
CNSTI4 6744
ADDP4
...
pop
line 139
;138:		// remember last ordered task
;139:		BotRememberLastOrderedTask(bs);
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 BotRememberLastOrderedTask
...
;146:/*
;147:==================
;148:BotVoiceChat_Defend
;149:==================
;150:*/
;151:void BotVoiceChat_Defend(bot_state_t* bs, int client, int mode) {
line 167
;152:#ifdef MISSIONPACK
;153:	if (gametype == GT_OBELISK || gametype == GT_HARVESTER) {
;154:		//
;155:		switch (BotTeam(bs)) {
;156:		case TEAM_RED:
;157:			memcpy(&bs->teamgoal, &redobelisk, sizeof(bot_goal_t));
;158:			break;
;159:		case TEAM_BLUE:
;160:			memcpy(&bs->teamgoal, &blueobelisk, sizeof(bot_goal_t));
;161:			break;
;162:		default:
;163:			return;
;164:		}
...
;169:	        || gametype == GT_1FCTF
;170:#endif
;171:	    ) {
line 173
;172:		//
;173:		switch (BotTeam(bs)) {
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 4
...
line 175
;174:		case TEAM_RED:
;175:			memcpy(&bs->teamgoal, &ctf_redflag, sizeof(bot_goal_t));
ADDRFP4 0
INDIRP4
CNSTI4 6624
ADDP4
...
line 178
;177:		case TEAM_BLUE:
;178:			memcpy(&bs->teamgoal, &ctf_blueflag, sizeof(bot_goal_t));
ADDRFP4 0
INDIRP4
CNSTI4 6624
ADDP4
...
ASGNF4
line 386
;385:	// set the time to send a message to the team mates
;386:	bs->teammessage_time = FloatTime() + 2 * random();
ADDRLP4 0
ADDRGP4 rand
CALLI4
ASGNI4
...
ASGNF4
line 388
;387:	// set the ltg type
;388:	bs->ltgtype = LTG_RETURNFLAG;
ADDRFP4 0
INDIRP4
CNSTI4 6600
ADDP4
...
ASGNI4
line 390
;389:	// set the team goal time
;390:	bs->teamgoal_time     = FloatTime() + CTF_RETURNFLAG_TIME;
ADDRFP4 0
INDIRP4
CNSTI4 6744
ADDP4
...
;398:/*
;399:==================
;400:BotVoiceChat_StartLeader
;401:==================
;402:*/
;403:void BotVoiceChat_StartLeader(bot_state_t* bs, int client, int mode) {
line 404
;404:	ClientName(client, bs->teamleader, sizeof(bs->teamleader));
ADDRFP4 4
INDIRI4
ARGI4
ADDRFP4 0
...
;407:/*
;408:==================
;409:BotVoiceChat_StopLeader
;410:==================
;411:*/
;412:void BotVoiceChat_StopLeader(bot_state_t* bs, int client, int mode) {
line 415
;413:	char netname[MAX_MESSAGE_SIZE];
;414:
;415:	if (!Q_stricmp(bs->teamleader, ClientName(client, netname, sizeof(netname)))) {
ADDRFP4 4
INDIRI4
ARGI4
ADDRLP4 0
...
;421:/*
;422:==================
;423:BotVoiceChat_WhoIsLeader
;424:==================
;425:*/
;426:void BotVoiceChat_WhoIsLeader(bot_state_t* bs, int client, int mode) {
line 429
...
line 511
;490:
;491:#ifdef MISSIONPACK
;492:voiceCommand_t voiceCommands[] = {
;493:	{VOICECHAT_GETFLAG,           BotVoiceChat_GetFlag          },
;494:	{VOICECHAT_OFFENSE,           BotVoiceChat_Offense          },
;495:	{VOICECHAT_DEFEND,            BotVoiceChat_Defend           },
;496:	{VOICECHAT_DEFENDFLAG,        BotVoiceChat_DefendFlag       },
;497:	{VOICECHAT_PATROL,            BotVoiceChat_Patrol           },
;498:	{VOICECHAT_CAMP,              BotVoiceChat_Camp             },
;499:	{VOICECHAT_FOLLOWME,          BotVoiceChat_FollowMe         },
;500:	{VOICECHAT_FOLLOWFLAGCARRIER, BotVoiceChat_FollowFlagCarrier},
;501:	{VOICECHAT_RETURNFLAG,        BotVoiceChat_ReturnFlag       },
;502:	{VOICECHAT_STARTLEADER,       BotVoiceChat_StartLeader      },
;503:	{VOICECHAT_STOPLEADER,        BotVoiceChat_StopLeader       },
;504:	{VOICECHAT_WHOISLEADER,       BotVoiceChat_WhoIsLeader      },
;505:	{VOICECHAT_WANTONDEFENSE,     BotVoiceChat_WantOnDefense    },
;506:	{VOICECHAT_WANTONOFFENSE,     BotVoiceChat_WantOnOffense    },
;507:	{NULL,						BotVoiceChat_Dummy            }
;508:};
;509:#endif
;510:
;511:int BotVoiceChatCommand(bot_state_t* bs, int mode, char* voiceChat) {
line 553
;512:#ifdef MISSIONPACK
;513:	int   i, voiceOnly, clientNum, color;
;514:	char *ptr, buf[MAX_MESSAGE_SIZE], *cmd;
;515:
;516:	if (!TeamPlayIsOn()) {
;517:		return qfalse;
;518:	}
;519:
;520:	if (mode == SAY_ALL) {
;521:		return qfalse;  // don't do anything with voice chats to everyone
;522:	}
;523:
;524:	Q_strncpyz(buf, voiceChat, sizeof(buf));
;525:	cmd = buf;
;526:	for (/*ptr = cmd*/; *cmd && *cmd > ' '; cmd++)
;527:		;
;528:	while (*cmd && *cmd <= ' ')
;529:		*cmd++ = '\0';
;530:	// voiceOnly = atoi(ptr);
;531:	for (ptr = cmd; *cmd && *cmd > ' '; cmd++)
;532:		;
;533:	while (*cmd && *cmd <= ' ')
;534:		*cmd++ = '\0';
...
;540:	// color = atoi(ptr);
;541:
;542:	if (!BotSameTeam(bs, clientNum)) {
;543:		return qfalse;
;544:	}
;545:
;546:	for (i = 0; voiceCommands[i].cmd; i++) {
;547:		if (!Q_stricmp(cmd, voiceCommands[i].cmd)) {
;548:			voiceCommands[i].func(bs, clientNum, mode);
;549:			return qtrue;
;550:		}
;551:	}
;552:#endif
