...
static qboolean CG_IsKnownModel(const char *modelName) {
	...
	if (Q_stricmp(modelName, "anarki") && Q_stricmp(modelName, "biker") && Q_stricmp(modelName, "bitterman") && Q_stricmp(modelName, "bones") &&
	    ...
	    Q_stricmp(modelName, "keel") && Q_stricmp(modelName, "klesk") && Q_stricmp(modelName, "lucy") && Q_stricmp(modelName, "major") &&
	    Q_stricmp(modelName, "mynx") && Q_stricmp(modelName, "orbb") && Q_stricmp(modelName, "ranger") && Q_stricmp(modelName, "razor") &&
	    Q_stricmp(modelName, "sarge") && Q_stricmp(modelName, "slash") && Q_stricmp(modelName, "sorlag") && Q_stricmp(modelName, "tankjr") &&
	    Q_stricmp(modelName, "uriel") && Q_stricmp(modelName, "visor") && Q_stricmp(modelName, "xaero"))
		return qfalse;
	else
		return qtrue;
}
...
void CG_NewClientInfo(int clientNum) {
	...
	CG_SetSkinAndModel(
		&newInfo, ci, v, allowNativeModel, clientNum, myClientNum, myTeam, qtrue, newInfo.modelName, sizeof(newInfo.modelName), newInfo.skinName,
		sizeof(newInfo.skinName));

	// head model
	v = Info_ValueForKey(configstring, "hmodel");
	CG_SetSkinAndModel(
		&newInfo, ci, v, allowNativeModel, clientNum, myClientNum, myTeam, qfalse, newInfo.headModelName, sizeof(newInfo.headModelName), newInfo.headSkinName,
