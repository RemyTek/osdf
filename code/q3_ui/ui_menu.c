...
#define BANNER_SEP  " | "
#define BANNER_TEXT MODNAME BANNER_SEP MODVERSION BANNER_SEP MODLICENSE
static void Main_MenuDraw(void) {
	...
	if (uis.demoversion) {
		...
		UI_DrawString(320, 400, BANNER_TEXT, UI_CENTER | UI_SMALLFONT, color);
	} else {
		UI_DrawString(320, 450, BANNER_TEXT, UI_CENTER | UI_SMALLFONT, color);
	}
}
